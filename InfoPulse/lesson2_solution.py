...
task4 = "Homework"
print('{:>46} {:>47}'.format(task4,""))#вывод строки на экран, слева 46 пробелов, справа 47. В сумме 100
a=('{:>50} {:>49}'.format(task4,""))# присваивание сгенерированной строки в переменную "а" для проверки
print(a.count(" "), "spaces") # подсчет количества пробелов в новой строке
print(len(a)) # длина сгенерированной строки
